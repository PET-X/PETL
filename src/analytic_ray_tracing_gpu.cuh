...
bool stoppingPower_gpu(float* g, parameters* params, phantom* aPhantom, bool data_on_cpu, int oversampling = 1);
bool rayTrace_gpu(float* g, parameters* params, phantom* aPhantom, bool data_on_cpu, int oversampling = 1, bool calc_stopping_power = false);
